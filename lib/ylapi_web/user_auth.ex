defmodule YlapiWeb.UserAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_ylapi_web_user_remember_me"
  ...
  the current_user:
      ...
      defmodule YlapiWeb.PageLive do
        use YlapiWeb, :live_view

        on_mount {YlapiWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{YlapiWeb.UserAuth, :ensure_authenticated}] do
